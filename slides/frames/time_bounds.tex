...
\begin{block}{Equation}
  $\UTime(t_0) \cdot (x-y) + \UTime(t_1) \cdot (x-y)$ \\
  $\UTime(t_0) \cdot \max(0,x-y) + \UTime(t_1) \cdot \max(0,x-y)$ \\
  $\UTime(t_0) \cdot \max(0,(\USize(t_0,x)-\LSize(t_0,y)) +$ \\
  $\UTime(t_1) \cdot \max(0,(\USize(t_1,x)-\LSize(t_1,y))$ \\
