...
\begin{align*}
  \onslide<14->{\UTime(t_3) =}& \onslide<9->{\UTime(t_0) \cdot} \onslide<11->{\max}\onslide<9->{(}\onslide<11->{0,}\onslide<12->{\USize(t_0,}\onslide<9->{x}\onslide<12->{)}\onslide<9->{-}\onslide<12->{\LSize(t_0,}\onslide<9->{y}\onslide<12->{)}\onslide<9->{)}\\
  \onslide<10->{+& \UTime(t_1) \cdot} \onslide<11->{\max}\onslide<10->{(}\onslide<11->{0,}\onslide<13->{\USize(t_1,}\onslide<10->{x}\onslide<13->{)}\onslide<10->{-}\onslide<13->{\LSize(t_1,}\onslide<10->{y}\onslide<13->{)}\onslide<10->{)}
\end{align*}
