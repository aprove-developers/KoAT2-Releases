\begin{columns}
  \begin{column}{0.6\textwidth}
    ...
    \begin{tikzpicture}[program]    
      ...
      node[above tlabel] {$if(x > y)$\\$x \coloneqq x - 1$\\$y \coloneqq \alt<-18>{\textcolor<18>{blue}{y}}{\textcolor<19-23>{blue}{z}}$\\\nodeshow{2-}{\textcolor<2,24-25>{blue}{$z \coloneqq \textcolor<5-6,11>{blue}{z} + \textcolor<7-8,12,13,15>{blue}{y}$}}}
  ...
  \begin{column}{0.4\textwidth}
    ...
    \begin{tikzpicture}[rvg]    
      ...
      (1y) edge[show on=<8->, highlight on=<8>, highlight on=<10>, highlight on=<13>, onslide=<20->bend right, onslide=<22->scc edge] (1z)
      (1z) edge[show on=<21->, highlight on=<21>, bend right, onslide=<22->scc edge] (1y)
      (0z) edge[show on=<23->, highlight on=<23>] (1y)
      ;
    \end{tikzpicture}
  \end{column}
\end{columns}
