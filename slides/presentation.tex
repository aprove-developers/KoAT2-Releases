...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[program]
      ...
      (1) edge[loop above] node[left] {$t_1$} node[right] {$if(x > 0)$\\$x \coloneqq x - 1$\\$y \coloneqq y + z$\\$z \coloneqq z$} (1)
      ;
    \end{tikzpicture}
    ...
    \begin{tikzpicture}[rvg]
      ...
      (1y) edge[loop right, scc edge] (1y)
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[program]
      ...
      \path[transitions]
      (0) edge node[above] {$t_0$} node[below] {$x \coloneqq x$\\$y \coloneqq y$} (1)
      (1) edge[loop above] node[left] {$t_1$} node[right] {$if(x > 0)$\\$x \coloneqq x - 1$\\$y \coloneqq 2 \cdot y$} (1)
      ;
    \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}[program]
      ...
      \path[transitions]
      (0) edge node[above] {$t_0$} node[below] {$x \coloneqq x$\\$y \coloneqq y$\\$z \coloneqq z$} (1)
      (1) edge[loop above] node[left] {$t_1$} node[right] {$if(x > 0)$\\$x \coloneqq x - 1$\\$y \coloneqq y + z$\\$z \coloneqq y$} (1)
      ;
    \end{tikzpicture}
