...
val get_variables : constraint_atom -> var list
val rename_vars : Variables.StringVariableTerm.rename_map -> constraint_atom -> constraint_atom
val instantiate_with_big_int : Variables.StringVariableTerm.valuation -> constraint_atom -> bool
