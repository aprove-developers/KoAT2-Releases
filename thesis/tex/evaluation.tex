...
First, some selected examples are presented, where the benefit of the presented method in contrast to the method of the original KoAT \cite{koat} is shown.
...
\todo{Activate picture}{}
\iffalse
\input{evaluations/cost_ranking_function}
\fi
