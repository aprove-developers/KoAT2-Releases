...
\begin{definition}[Valuation] 
	A valuation is a function $\valuation: \VSet \rightarrow \mathbb{Z}$\comment{This should be called a state, even if it was called valuation before} which assigns each program variable a value.
\end{definition}
