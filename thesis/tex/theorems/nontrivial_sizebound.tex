...
\begin{theorem}[SizeBounds for nontrivial SCCs]
  ...
  \[ \text{in}^\sqcap_\alpha = \sum_{v \in (P_{\alpha,+}^\sqcap \cup Q_{\alpha,+}^\sqcap) \setminus \VSet_\alpha} \text{in}^\sqcap_{\alpha,v} + \sum_{v \in (P_{\alpha,-}^\sqcap \cup Q_{\alpha,-}^\sqcap) \setminus \VSet_\alpha} \text{in}^\sqcup_{\alpha,v} \]
  \[ \text{in}^\sqcup_\alpha = \sum_{v \in (P_{\alpha,+}^\sqcup \cup Q_{\alpha,+}^\sqcup) \setminus \VSet_\alpha} \text{in}^\sqcup_{\alpha,v} + \sum_{v \in (P_{\alpha,-}^\sqcup \cup Q_{\alpha,-}^\sqcup) \setminus \VSet_\alpha} \text{in}^\sqcap_{\alpha,v} \]
