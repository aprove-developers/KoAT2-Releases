...
Prior to the definition of the method, four utility definitions are given, with three of them also used by the KoAT paper \cite{koat}.
...
Now we are able to specialize the method SizeBounds of the KoAT paper \cite{koat} for nontrivial non-negating size bounds.

\input{theorems/nontrivial_sizebound}

This definition extends the method of the KoAT paper \cite{koat} to a differentiation of upper and lower size bounds.
