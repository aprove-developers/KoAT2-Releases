...
This subset can be understood as equivalent representation of the polynomial ring $\mathbb{Z}[\VSet]$.
...
\begin{definition}[Atom set and constraint set]
  ...
  Furthermore, we define the constraint set $\ConstraintSet = 2^\AtomSet$ as set of conjunctions of polynomial inequalities.
\end{definition}
