...
\begin{definition}[Program] 
  ...
  \todo{Not yet decided}{Let $\TSet = \LSet \times ((\VSet \rightarrow \BoundSet_p) \times (\VSet \rightarrow \BoundSet_p)) \times 2^\AtomSet \times \LSet$ be the set of all transitions of the program.}
