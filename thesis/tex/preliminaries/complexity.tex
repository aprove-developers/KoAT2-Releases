...
\todo{We should define the upper time bound first}{}
...
The upper time bound of transition $t \in \TSet$ describes the maximal number of occurrences of that transition in an evaluation starting with an arbitrary initial state $\valuation_0 \in \Valuation$.
...
\todo{To be proved}{This does not affect the known theorem, that it is possible to approximate the time complexity of a program by the sum of all upper time bounds.}
