...
\todo{Add figure here depending on position of chapter}{Consider the motivational program in Figure \ref{fig:motivational_example}.}
...
Lifting these time bounds into the context of the outer program, we consider them as cost of the transition of the outer program. \todo{Example or later?}{}
