...
\begin{definition}[Entry Transitions and Entry Locations \cite{koat}]
...
\begin{example}[Time Bounds]
  ...
  The method of \cite{koat} would now apply an operator to $\timerank$, such that the result would be a monotonic function with $\timerank'(\location_1) = \abs{x} + \abs{y}$.
