...
\begin{algorithmic}[1]
  ...
  \Repeat
    ...
    \ForAll{SCCs $\TSet'$ of $P$ in topological order}
      \State Run $\text{TimeBounds}(\UTime, \Size, \braced{t \in \TSet' \mid \UTime(t) = \infty})$
    \EndFor
