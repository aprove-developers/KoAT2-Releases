...
\subsection{Initial time bounds}
...
The implementation of an algorithm for the computation of local size bounds needs to yield good local size bounds while providing good performance.
