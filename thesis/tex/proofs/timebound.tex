...
\begin{IEEEeqnarray*}{rCl}
  \sum_{\location \in \mathcal{E}_{\TSet'}} \sum_{\tilde{t} \in \TSet_l} \eval{\UTime(\tilde{t})}{m} \cdot \maxO{\eval{\Pol(\location)_+}{m^\sqcap_{\tilde{t}}} - \eval{\Pol(\location)_-}{m^\sqcup_{\tilde{t}}}} \\
...
\begin{IEEEeqnarray*}{rCl}
  \sum_{\location \in \mathcal{E}_{\TSet'}} \sum_{\tilde{t} \in \TSet_l} \eval{\UTime(\tilde{t})}{m} \cdot \maxO{\eval{\Pol(\location)_+}{m^\sqcap_{\tilde{t}}} - \eval{\Pol(\location)_-}{m^\sqcup_{\tilde{t}}}} \geq k
\end{IEEEeqnarray*}
