...
\begin{IEEEeqnarray*}{rCl}
  ...
  \geq \sup \braced{k \in \mathbb{N} \mid \exists \location', \valuation', \valuation_0: \abs{\valuation_0} \leq m \wedge (\location_0, \valuation_0) \valuateto{t}^k (\location', \valuation')}
\end{IEEEeqnarray*}
