We want to prove the following claim for all \todo{Exclude t0}{$t \in \TSet$} and all $m: \VSet \rightarrow \mathbb{N}$.
...
\begin{IEEEeqnarray*}{rCl}
  \sum_{\location \in \mathcal{E}_{\TSet'}} \sum_{\tilde{t} \in \TSet_l} \eval{\UTime(\tilde{t})}{m} \cdot \maximum{0, \eval{\Pol(\location)_+}{m^\sqcap_{\tilde{t}}} - \eval{\Pol(\location)_-}{m^\sqcup_{\tilde{t}}}} \\
...
\begin{IEEEeqnarray*}{rCl}
  \sum_{\location \in \mathcal{E}_{\TSet'}} \sum_{\tilde{t} \in \TSet_l} \eval{\UTime(\tilde{t})}{m} \cdot \maximum{0, \eval{\Pol(\location)_+}{m^\sqcap_{\tilde{t}}} - \eval{\Pol(\location)_-}{m^\sqcup_{\tilde{t}}}} \geq k
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{lCl}
  \eval{\Pol(\hat{\location}_i)_+}{m^\sqcap_{\tilde{t}_i}} \geq \eval{\Pol(\hat{\location}_i)_+}{\hat{\valuation}_i} \\
  \eval{\Pol(\hat{\location}_i)_-}{m^\sqcup_{\tilde{t}_i}} \leq \eval{\Pol(\hat{\location}_i)_-}{\hat{\valuation}_i}
\end{IEEEeqnarray*}
