...
\begin{IEEEeqnarray*}{rCl}
  \sum_{\location \in \mathcal{E}_{\TSet'}} \sum_{\pret \in \TSet_l} \exacteval{\UTime(\pret)}{\valuation_0} \cdot \maxO{\exacteval{\usubst{\timerank(\location)}{\LSize(\pret)}{\USize(\pret)}}{\valuation_0}} \\
  \geq \timeboundterm
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{rCl}
  \sum_{\location \in \mathcal{E}_{\TSet'}} \sum_{\pret \in \TSet_l} \exacteval{\UTime(\pret)}{\valuation_0} \cdot \maxO{\exacteval{\usubst{\timerank(\location)}{\LSize(\pret)}{\USize(\pret)}}{\valuation_0}} \geq k
\end{IEEEeqnarray*}
