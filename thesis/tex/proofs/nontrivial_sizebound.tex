...
\begin{equation} \label{eq:sizebound_hypothesis}
  \forall v \in \VSet: \ueval{d^\sqcap}{\lstate}{\ustate} \geq \maxO{\actstate(v)} \wedge \leval{d^\sqcup}{\ustate}{\lstate} \geq \maxO{-\actstate(v)}
\end{equation}
...
Furthermore $\ueval{\effect^\sqcap_\actt}{\lstate}{\ustate} \geq 0$, $\leval{\effect^\sqcup_\actt}{\ustate}{\lstate} \geq 0$ and $\start \geq 0$ hold by definition of the theorem.
...
\[ \leval{{\mathcal{S}^\sqcup}'(\actt,v)}{\lstate}{\ustate} =
   (-1) \cdot \prod_{t \in \TSet_\SCC} (\scale^\sqcup_t)^{\ueval{\UTime(t)}{\ustate}{\lstate}} \cdot \left( \ueval{\start}{\lstate}{\ustate} + \sum_{t \in \TSet_\SCC} \left( \ueval{\UTime(t)}{\lstate}{\ustate} \cdot \ueval{\effect^\sqcup_t}{\lstate}{\ustate} \right) \right) \leq \ueval{d^\sqcup}{\lstate}{\ustate} \]
...
If $(\pret, v) \in \SCC$, then the induction hypothesis implies that $\ueval{d^\sqcap}{\lstate}{\ustate} \geq \maxO{\prestate(v)}$ and $\leval{d^\sqcup}{\ustate}{\lstate} \geq \maxO{-\prestate(v)}$ also hold for the evaluation from $(\location_0, \valuation_0)$ to $(\prel, \prestate)$.
