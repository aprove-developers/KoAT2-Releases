...
\begin{IEEEeqnarray*}{rClr} \label{eq:input_rv_reduction}
  ...
  & = & \sum_{v \in P_{\hat{\alpha}}^\sqcap \setminus \VSet_{\hat{\alpha}}} \maxO{\USize(\tilde{t}, v)(m)}
    + \sum_{v \in N_{\hat{\alpha}}^\sqcap} \maxO{-\LSize(\tilde{t}, v)(m)} \\
  & \geq & \sum_{v \in P_{\hat{\alpha}}^\sqcap \setminus \VSet_{\hat{\alpha}}} \maxO{\tilde{\valuation}(v)}
    + \sum_{v \in N_{\hat{\alpha}}^\sqcap} \maxO{-\tilde{\valuation}(v)} \\
  & \geq & \sum_{v \in P_{\hat{\alpha}}^\sqcap} \maxO{\tilde{\valuation}(v)}
    - \sum_{v \in \VSet_{\hat{\alpha}}} \maxO{\tilde{\valuation}(v)}
    + \sum_{v \in N_{\hat{\alpha}}^\sqcap} \maxO{-\tilde{\valuation}(v)}
\end{IEEEeqnarray*}
