...
\begin{IEEEeqnarray*}{rClr}
  d^\square & = & s^\square_{\TSet} \cdot \sum_{t \in \TSet} \left( k_t \cdot \text{in}^\square_t(m) \right) \\
  & = & \left( s^\square_r \cdot (s^\square_r)^{k_r - 1} \cdot s^\square_{\TSet \setminus \braced{r}} \right) \cdot \\
  ...
  & = & s^\square_r \cdot {d^\square}' + \left( s^\square_r \cdot (s^\square_r)^{k_r - 1} \cdot s^\square_{\TSet \setminus \braced{r}} \cdot \text{in}^\square_r(m) \right) \\
  & = & s^\square_r \cdot \left( {d^\square}' + (s^\square_r)^{k_r - 1} \cdot s^\square_{\TSet \setminus \braced{r}} \cdot \text{in}^\square_r(m) \right) \\
