...
\todo{Lower case}{Note that following sentence holds.}
...
\begin{IEEEeqnarray*}{rClr} \label{eq:input_rv_reduction}
  & & \text{in}^\sqcap_{(r, w')}(m) \\
  & = & \sum_{v \in (P_{{(r, w')},+}^\sqcap \cup Q_{{(r, w')},+}^\sqcap) \setminus \VSet_{(r, w')}} \text{in}^\sqcap_{{(r, w')},v}(m)
    + \sum_{v \in (P_{{(r, w')},-}^\sqcap \cup Q_{{(r, w')},-}^\sqcap)} \text{in}^\sqcup_{{(r, w')},v}(m) \\
  & = & \sum_{v \in (P_{{(r, w')},+}^\sqcap \cup Q_{{(r, w')},+}^\sqcap) \setminus \VSet_{(r, w')}} \max (0, \USize(\tilde{r}, v')(m))
    + \sum_{v \in (P_{{(r, w')},-}^\sqcap \cup Q_{{(r, w')},-}^\sqcap)} \max (0, -\LSize(\tilde{r}, v')(m)) \\
  & \geq & \sum_{v \in (P_{{(r, w')},+}^\sqcap \cup Q_{{(r, w')},+}^\sqcap) \setminus \VSet_{(r, w')}} \max(0, \valuation_{\tilde{r}}(v))
    + \sum_{v \in (P_{{(r, w')},-}^\sqcap \cup Q_{{(r, w')},-}^\sqcap)} \max(0, -\valuation_{\tilde{r}}(v)) \\
  & \geq & \sum_{v \in (P_{{(r, w')},+}^\sqcap \cup Q_{{(r, w')},+}^\sqcap)} \max(0, \valuation_{\tilde{r}}(v))
...
\begin{IEEEeqnarray*}{rClr}
  ...
  & = & s^\square_r \cdot {d^\square}' + \left( s^\square_r \cdot (s^\square_r)^{k_r - 1} \cdot \prod_{t \in \TSet \setminus \braced{r}} (s^\square_t)^{k_t} \cdot \text{in}^\square_r(m) \right) & (\ref{eq:induction_consequence}) \\
  & = & s^\square_r \cdot \left( {d^\square}' + (s^\square_r)^{k_r - 1} \cdot \prod_{t \in \TSet \setminus \braced{r}} (s^\square_t)^{k_t} \cdot \text{in}^\square_r(m) \right) \\
  ...
  & = & s^\square_{(r, w')} \cdot ( \pm e^{\square}_{(r, w')} + \sum_{v \in (P_{{(r, w')},+}^\sqcap \cup Q_{{(r, w')},+}^\sqcap)} \max(0, \valuation_{\tilde{r}}(v)) \\
    && + \sum_{v \in (P_{{(r, w')},-}^\sqcap \cup Q_{{(r, w')},-}^\sqcap)} \max(0, -\valuation_{\tilde{r}}(v)) )
    & (\ref{eq:input_rv_reduction}) \\
  & \geq & s^\square_{(r, w')} \cdot ( \pm e^\square_{(r, w')} + \sum_{v \in P_{(r, w'),+}^\sqcap} \valuation_{\tilde{r}}(v) - \sum_{v \in P_{(r, w'),-}^\sqcap} \valuation_{\tilde{r}}(v) \\
    && + \sum_{v \in Q_{(r, w'),+}^\sqcap} \max \braced{0,\valuation_{\tilde{r}}(v)} - \sum_{v \in Q_{(r, w'),-}^\sqcap} \min \braced{0,\valuation_{\tilde{r}}(v)} ) & (\ref{eq:maxmineq}) \\
