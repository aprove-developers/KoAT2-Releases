...
The method of the KoAT paper \cite{koat} uses monotonically increasing bounds for the local size bounds.
...
\begin{example}[SizeBounds for trivial SCCs with an initial transition]
...
\begin{example}[SizeBounds for trivial SCCs with a non-initial transition]
