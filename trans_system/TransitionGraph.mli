module TransitionGraph :
  sig
    type t =
        Graph.Imperative.Digraph.AbstractLabeled(Locations)(Transitions).t
    module V :
      sig
        type t =
            Graph.Imperative.Digraph.AbstractLabeled(Locations)(Transitions).V.t
        val compare : t -> t -> int
        val hash : t -> int
        val equal : t -> t -> bool
        type label = Locations.t
        val create : label -> t
        val label : t -> label
      end
    type vertex = V.t
