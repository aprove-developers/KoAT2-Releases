...
sig
  ...
  val to_string : ([`Lower | `Upper] -> TransitionLabel.t -> Var.t -> Bound.t) -> [`Lower | `Upper] -> t -> string
  val hash : t -> int
...
sig
  ...
  val rvs_to_string : ([`Lower | `Upper] -> TransitionLabel.t -> Var.t -> Bound.t) -> RV.t list -> string
