...
sig
    ...
    val poly_as_list: t -> Polynomials.Polynomial.t list

    val inv_poly_as_list: t -> Polynomials.ParameterPolynomial.t list

    val of_poly_list: VarSet.elt list -> Polynomials.Polynomial.t list -> t

    val identity_end : t 

    val apply_for_parameter_poly:  t -> Polynomials.ParameterPolynomial.t -> Polynomials.ParameterPolynomial.t

    val enumerate_help: int -> int -> int list list 

    val enumerate_all_polys_degree: int -> Var.t list -> Polynomials.Polynomial.t list

    val degree_of_polylist: Polynomials.Polynomial.t list -> int
