...
val perform_analysis : ?conf:configuration -> Program.t -> ClassicalApproximation.t -> ExpApproximation.t

val perform_classic_and_probabilistic_analysis :
  ?classic_conf:NonProbOverappr.program_modules_t Analysis.analysis_configuration ->
  ?conf:configuration ->
  Program.t ->
