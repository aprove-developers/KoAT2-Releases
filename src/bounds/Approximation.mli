...
type bound = MinMaxPolynomial.Make(Polynomials.Make(PolyTypes.OurInt)).t
...
val timebound : kind -> t -> Transition.t -> bound

(** Returns a timebound of the specified kind for the execution of the whole graph. *)
val timebound_graph : kind -> t -> Program.t -> bound
...
val add_timebound : kind -> bound -> Transition.t -> t -> t
