...
val improve : rvg_with_sccs -> ?mprf_max_depth:int -> preprocess:(Program.t -> Program.t) -> ?cfr:bool -> ?inv:bool -> ?fast:bool -> [ `Cost | `Time ] -> Program.t -> Approximation.t ->  Program.t * Approximation.t
