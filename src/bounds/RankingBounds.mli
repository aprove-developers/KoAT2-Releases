...
val improve : RVGTypes.RVG.t -> ?mprf_max_depth:int -> ?cfr:bool -> ?inv:bool -> ?fast:bool -> [ `Cost | `Time ] -> Program.t -> Approximation.t ->  Program.t * Approximation.t * RVGTypes.RVG.t
