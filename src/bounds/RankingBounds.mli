...
val improve : RVGTypes.RVG.t -> MultiphaseRankingFunction.ranking_cache -> ?cfr:bool -> ?inv:bool -> ?fast:bool -> [ `Cost | `Time ] -> Program.t -> Approximation.t ->  Program.t * Approximation.t * RVGTypes.RVG.t
