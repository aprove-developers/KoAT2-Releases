...
let suite =
  "Graphs" >::: [
      ...
      (
        "Print" >:: (fun _ ->
          Program.print_system "sect1-lin" (Reader.read_file "../../examples/KoAT-2013/sect1-lin.koat");
          Program.print_rvg "sect1-lin" (Reader.read_file "../../examples/KoAT-2013/sect1-lin.koat")
        )
      );
    ]
