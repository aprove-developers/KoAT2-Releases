  ...
  "ExpectedChangeBoundTests" >:::
    List.mapi
      (fun i (gt, expected) ->
         ...
         let program_vars = VarSet.of_list (LazyList.to_list @@ LazyList.take 1 Var.args) in
