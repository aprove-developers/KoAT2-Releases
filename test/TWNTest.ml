         ...
         List.map ~f:(fun (expected_string, expr) ->
             "" >:: (fun _ ->
                  ...
                  [
                    ...
                    ("[[[n == 0]] * x + [[n != 0]] * 42; [[n == 0]] * y + [[n != 0, n == 1]] * x^2 + [[n != 0, n != 1]] * 1764; [[n == 0]] * z + [[n != 0, n == 1]] * (x+x*y+5*y) + [[n != 0, n != 1]] * 42 + [[n != 0, n != 1, n == 2]] * 47*x^2 + [[n != 0, n != 1, n != 2]] * 82908]", [("x","42"); ("y","x*x"); ("z", "x+x*y+5*y")]);
                    ("[x]", [("x","x")]);
                    ("[x * 5^n]", [("x","5*x")]);
                    ...
                    ("[x + [[n != 0]] * 2 * n^1; [[n == 0]] * z + [[n != 0]] * 1+x + [[n != 0, n != 1]] * 2 * n^1 + [[n != 0, n != 1]] * -2]", [("x", "x + 2"); ("z", "x+1")]);
                    ("[[[n == 0]] * w + [[n != 0]] * 2; y * 4^n + [[n != 0]] * 1/2*w-2/3 * 4^n + [[n != 0]] * 2/3 + [[n != 0, n != 1]] * 1/3 * 4^n + [[n != 0, n != 1]] * -4/3]", [("w","2"); ("y", "2*w+4*y-2")]);
                    ("[x; y + [[n != 0]] * -2*x^2 * n^1; z + [[n != 0]] * x*y^2 * n^1 + [[n != 0, n != 1]] * 4/3*x^5 * n^3 + [[n != 0, n != 1]] * (-2*x^3*y-2*x^5) * n^2 + [[n != 0, n != 1]] * (2*x^3*y+2/3*x^5) * n^1]", [("x", "x"); ("y", "y - 2 * x * x"); ("z", "z + y * y * x")]);
         ...
         List.map ~f:(fun (expected_string, expr) ->
             "" >:: (fun _ ->
                  ...
                  [
                    ...
                    ("[x; -2*x^2 * n^1 + y; 4/3*x^5 * n^3 + (-2*x^3*y-2*x^5) * n^2 + (x*y^2+2*x^3*y+2/3*x^5) * n^1 + z]", [("x", "x"); ("y", "y - 2 * x * x"); ("z", "z + y * y * x")]);
